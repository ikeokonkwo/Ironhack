...
module RbConfig
  RUBY_VERSION.start_with?("2.3.") or
    raise "ruby lib version (2.3.4) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "3"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "301"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/app/vendor/ruby-2.3.4")
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix' '/app/vendor/ruby-2.3.4' '--enable-load-relative'"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.3.4"
